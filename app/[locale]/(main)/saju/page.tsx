...
const sajuServices: SajuService[] = [
  ...
  {
    id: 'saju-analysis',
    titleKey: 'sajuAnalysis',
    descriptionKey: 'sajuAnalysisDesc',
    icon: Sparkles,
  ...
  {
    id: 'premium-saju',
    titleKey: 'premiumSaju',
    descriptionKey: 'premiumSajuDesc',
    icon: Star,
    ...
    points: 2000,
    originalPoints: 2500,
    href: '/fortune/saju?tier=premium',
    badge: 'VIP',
  },
  {
    id: 'compatibility',
